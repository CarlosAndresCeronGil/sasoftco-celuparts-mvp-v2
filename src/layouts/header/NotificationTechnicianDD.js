...
import getRequestNotificationToTechnicianFirstThree from '../../services/getRequestNotificationToTechnicianFirstThree'
...
const NotificationTechnicianDD = () => {
                ...
                <ListGroup flush>
                    {
                        alerts.map((msg, index) => (
                            msg.notificationType === "to_technician" &&
...
export default NotificationTechnicianDD;
