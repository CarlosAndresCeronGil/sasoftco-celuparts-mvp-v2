...
const RegisterFormik = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    password: Yup.string()
      ...
      .matches(
        /^(?=.*[()!*@#%&+{}])/,
        "La contraseña debe tener al menos un caracter especial, ejemplo: !@#%&"
      )
      ...
      <div className="container py-5 h-100">
        <div className="row d-flex justify-content-center align-items-center h-100">
          <div className="col-xxl-10">
            <div
              className="mb-sm-5 mb-2 mt-4 mt-lg-2 d-flex justify-content-center"
              style={{ position: "relative", zIndex: "2" }}
            >
              <img
                src="/celuparts-transparent-2.png"
                alt="celuparts-logo"
                className="right-card-image w-25"
              ></img>
            </div>
            <div className="card rounded-3 text-black shadow-lg">
              <div className="row g-0 ">
                <div className="col-lg-5 d-flex align-items-center gradient-custom-2">
                  <div className="px-0">
                    <img
                      className="d-none d-lg-block float-left rounded-start"
                      style={{ textDecoration: "none" }}
                      src="registrousuario.png"
                      height="600"
                      alt="logo"
                    />
                  </div>
